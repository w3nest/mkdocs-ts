...
You can find this example as standalone HTML file <a href="{{URL-example1}}" target="_blank">here</a>.

### Typical organization

**Setup**

For real projects, it is recommended to use TypeScript to build your application. Here’s how to get started:
...
*  Add the following script to your `index.html`'s header to make the webpm client available if 
   needed: `<script src="https://webpm.org/^3.0.0/webpm-client.js"></script>`
...
of this very application can help you to get started.
...
Additionally, you can provide custom styles to the cell-output.
...
<note level="info">
The above cell also gives an example of Markdown cell, included using the DOM element `md-cell`.
</note>

<note level="hint">
Deported outputs can also set `full-screen='true'` attribute to provide a menu allowing to extend the rendering area.
</note>
